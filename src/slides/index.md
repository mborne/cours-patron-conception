...
Si j'appelle `chaine.upper()` pour transformer la chaîne en majuscule, je ferai appel à la **notation pointée** typique de la P.O.O.
...
**Utiliser des classes existantes ne demandera pas d'effort**. Il sera toutefois plus délicat de :
...
* J'ignore la 3D tant que j'en l'utilise pas dans mon application.
